				      ...
				      GError **error)
{
	...
	gsize bufz = 0;
	g_autoptr(FuLenovoHidCmd) lenovo_hid_cmd = fu_lenovo_hid_cmd_new();
	g_autoptr(FuLenovoHidData) lenovo_hid_data = fu_lenovo_hid_data_new();
	fu_lenovo_hid_cmd_set_target_status(lenovo_hid_cmd, 0x00);
	fu_lenovo_hid_cmd_set_data_size(lenovo_hid_cmd, 0x03);
	fu_lenovo_hid_cmd_set_command_class(lenovo_hid_cmd,
					    FU_LENOVO_ACCESSORY_COMMAND_CLASS_DEVICE_INFORMATION);
	fu_lenovo_hid_cmd_set_command_id(lenovo_hid_cmd,
					 FU_LENOVO_ACCESSORY_INFO_ID_FIRMWARE_VERSION |
					     (FU_LENOVO_HID_CMD_DIR_CMD_GET << 7));
	fu_lenovo_hid_cmd_set_flag_profile(lenovo_hid_cmd, 0x00);
					       ...
					       GError **error)
{
	...
	g_autoptr(FuLenovoHidData) lenovo_hid_data = fu_lenovo_hid_data_new();
	fu_lenovo_hid_cmd_set_target_status(lenovo_hid_cmd, 0x00);
	fu_lenovo_hid_cmd_set_data_size(lenovo_hid_cmd, 0x01);
	fu_lenovo_hid_cmd_set_command_class(lenovo_hid_cmd,
					    FU_LENOVO_ACCESSORY_COMMAND_CLASS_DEVICE_INFORMATION);
	fu_lenovo_hid_cmd_set_command_id(lenovo_hid_cmd,
					 FU_LENOVO_ACCESSORY_INFO_ID_DEVICE_MODE |
					     (FU_LENOVO_HID_CMD_DIR_CMD_SET << 8));
	fu_lenovo_hid_cmd_set_flag_profile(lenovo_hid_cmd, 0x00);
	fu_lenovo_hid_data_set_reportid(lenovo_hid_data, 0x00);
	if (!fu_lenovo_hid_data_set_cmd(lenovo_hid_data, lenovo_hid_cmd, error))
		return FALSE;
...
fu_lenovo_accessory_command_dfu_exit(FuHidrawDevice *hidraw_device, guint8 exit_code)
{
	...
	g_autoptr(FuLenovoHidData) lenovo_hid_data = fu_lenovo_hid_data_new();
	fu_lenovo_hid_cmd_set_target_status(lenovo_hid_cmd, 0x00);
	fu_lenovo_hid_cmd_set_data_size(lenovo_hid_cmd, 0x00);
	fu_lenovo_hid_cmd_set_command_class(lenovo_hid_cmd,
					  ...
					  GError **error)
{
	...
	g_autoptr(FuLenovoHidData) lenovo_hid_data = fu_lenovo_hid_data_new();
	fu_lenovo_hid_cmd_set_target_status(lenovo_hid_cmd, 0x00);
	fu_lenovo_hid_cmd_set_data_size(lenovo_hid_cmd, 0x0D);
	fu_lenovo_hid_cmd_set_command_class(lenovo_hid_cmd,
					    FU_LENOVO_ACCESSORY_COMMAND_CLASS_DFU_CLASS);
	fu_lenovo_hid_cmd_set_command_id(lenovo_hid_cmd,
				     ...
				     GError **error)
{
	...
	g_autoptr(FuLenovoHidData) lenovo_hid_data = fu_lenovo_hid_data_new();
	fu_lenovo_hid_cmd_set_target_status(lenovo_hid_cmd, 0x00);
	fu_lenovo_hid_cmd_set_data_size(lenovo_hid_cmd, block_size + 5);
	fu_lenovo_hid_cmd_set_command_class(lenovo_hid_cmd,
					    FU_LENOVO_ACCESSORY_COMMAND_CLASS_DFU_CLASS);
	fu_lenovo_hid_cmd_set_command_id(lenovo_hid_cmd,
